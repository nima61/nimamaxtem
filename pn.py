...
def sendMentionFooter(to, mid, firstmessage, lastmessage):
    try:
        ...
        ticket = "https://line.me/ti/p/~max_pv"
                        ...
                        try:
                            if settings["autolike"] == True:
                                ...
                                if purl[1] not in wait['postId']:
                                    ...
                                    am = "『 AUTO LIKE NIMA MAX BOT』"
                                    data = {
                                           "type": "text",
                                           "text": "{}".format(str(am)),
                                           "sentBy": {
                                           "label": "𝐀𝐌𝐛𝐨𝐭𝐥𝐢𝐧𝐞",
                                           "iconUrl": "https://i.imgflip.com/3fwe81.gif",
       ...
       # "type": "button",
        ...
        #  "uri": "https://line.me/ti/p/~max_pv",
                    ...
                    time.sleep(1)
                            ...
                            ret = "🔰➫꙲     Joox [ judul lagu ]\n"
                            ret += "🔰➫꙲     Smule [ id ]\n"
                            ret += "🔰➫꙲     Yt [ judul ]\n"
                            ret += "🔰➫꙲     Youtube [ judul ]\n"
                            ret += "🔰➫꙲     Playstore [ nama app ]\n"
                            ret += "🔰➫꙲     Image [ nama ]\n"
                            ret += "🔰➫꙲     Poto [ nama ]\n"
                            ret += "🔰➫꙲     Text [ text ]\n"
                            ret += "🔰➫꙲     Memelist\n"
                ...
                "contents": [
                    ...
                    #        "url": "https://obs.line-scdn.net/{}".format(achink.getContact(achinkMID).pictureStatus),
                        ...
                        "contents": [
                            ...
                            ret = "🔰➫꙲     Autojoin on/off\n"
                            ret += "🔰➫꙲     Autoblock on/off\n"
                            ret += "🔰➫꙲     Autolike on/off\n"
                            ret += "🔰➫꙲     Stealtag on/off\n"
                            ret += "🔰➫꙲     Autocomment on/off\n"
                            ret += "🔰➫꙲     Autojointicket on/off\n"
                            ret += "🔰➫꙲     Responkick on/off\n"
                            ret += "🔰➫꙲     Chatbot on/off\n"
                            ret += "🔰➫꙲     Unsend on/off\n"
                            ret += "🔰➫꙲     Prokick on/off\n"
                            ret += "🔰➫꙲     Procancel on/off\n"
                            ret += "🔰➫꙲     Proinvite on/off\n"
                            ret += "🔰➫꙲     Proqr on/off\n"
                            ret += "🔰➫꙲     Allpro on/off\n"
                            ret += "🔰➫꙲     Nama [ text ]\n"
                            ret += "🔰➫꙲     Bio [ text ]\n"
                            ret += "🔰➫꙲     Autocancel on/off"
                            data = {
                            "type": "flex",
                                    "altText": "MENU KICK",
                                        "contents": {
                ...
                "contents": [
                    ...
                    #        "url": "https://obs.line-scdn.net/{}".format(achink.getContact(achinkMID).pictureStatus),
                        ...
                        "contents": [
                            ...
                            ret += "🔰➫꙲     .Pamit\n"
                            ret += "🔰➫꙲     Au [ ini virus ]\n"
                            ret += "🔰➫꙲     Cvpurl [ link youtubenya ]\n"
                            ret += "🔰➫꙲     Kasih gif [ jumlah] [ @ ]\n"
                            ret += "🔰➫꙲     Spam 1 [ jumlah ] [ @ ]\n"
                            ret += "🔰➫꙲     Spam 2 [ jumlah ] [ @ ]\n"
                            ret += "🔰➫꙲     Spam 3 [ jumlah ] [ @ ]\n"
                            ret += "🔰➫꙲     Spam 4 [ jumlah ] [ @ ]\n"
                ...
                "contents": [
                            ...
                            "hero": {
                            "type": "image",
                            "url": "https://i.imgflip.com/3fwa5s.gif",
                    #        "url": "https://obs.line-scdn.net/{}".format(achink.getContact(achinkMID).pictureStatus),
                            "size": "full",
                        #    "aspectRatio": "1:1",
                        #    "aspectMode": "fit",
      ...
      "type": "button",
                                ...
                                "action": {
                                    ...
                                    if num <= len(data["list"]):
                                        ...
                                        data = json.loads(data)
                                        if data["list"] != []:
                                            am = "🔰➫꙲    Detail Record Smule"
                                            am += "\n🔰➫꙲     Pembuat OC: "+str(smule["owner"]["handle"])
                                            am += "\n🔰➫꙲     Judul: "+str(smule["title"])
                                            am += "\n🔰➫꙲     Bio: "+str(smule["message"])
                                            am += "\n🔰➫꙲     Pemutar: "+str(smule["stats"]["total_listens"])
                                            am += "\n🔰➫꙲     Like: "+str(smule["stats"]["total_loves"])
                                            am += "\n🔰➫꙲     Komentar: "+str(smule["stats"]["total_comments"])
                                            am += "\n🔰➫꙲    Witing Audio and Video"
                                            hasil = "🔰➫꙲    Detail Record\n\n"+str(am)
    ...
    "contents": [
      ...
      "type": "button",
                    ...
                    try:
                        ...
                        ret_ = "\n➫꙲   Nama : {}".format(contact.displayName)
                        ret_ += "\n➫꙲   Total Group : {}".format(str(len(grouplist)))
                        ret_ += "\n➫꙲   Teman : {}".format(str(len(contactlist)))
                        ret_ += "\n➫꙲   Teman block : {}".format(str(len(blockedlist)))
                        ret_ += "\n➫꙲  ️ Total undangan : {}".format(str(len(IdsInvit)))
                        ret_ += "\n➫꙲   Aktip  :{}".format(str(runtime))
                        ret_ += "\n➫꙲   Creator : {}".format(str(creator.displayName))
                ...
                if text.lower() == ".runtime" or text.lower() == ".runtime":
                    ...
                    if msg._from in achinkMID:
                        if apalo["Talkblacklist"] == []:
                            ...
                            m="**Contoh 1**\nPesan ubah warna me\nPim 'beri saya warna #FF0F00'\n**Contoh 2**\nUbah perintah tag warna\nSet Warna Pim 'Tack #FF0F00'"
                ...
                for sticker in stickers2:
                    try:
                        if text.lower() == sticker:
                            ...
                            if a.hasAnimation == True:data = {"type": "template","altText": "{} sent a sticker.".format(achink.getProfile().displayName),"template": {"type": "image_carousel","columns": [{"imageUrl": "https://stickershop.line-scdn.net/stickershop/v1/sticker/{}/IOS/sticker_animation@2x.png".format(sid),"size": "full","action": {"type": "uri","uri": "http://line.me/ti/p/~max_pv"}}]}}
